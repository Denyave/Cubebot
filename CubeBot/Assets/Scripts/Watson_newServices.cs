...
public class Watson_newServices : MonoBehaviour
{
    ...
    private void StopRecording()
    {
        if (_recordingRoutine != 0)
        {
            ...
            _recordingRoutine = 0;
            Debug.Log("I stopped LISTENING, mawh gawd");
        }
    }
    ...
    private void GetTTS()
    {
        ...
        _TTSservice.Voice = VoiceType.en_US_Michael; // .en_US_Michael; // .en_US_Allison; //.en_GB_Kate;
